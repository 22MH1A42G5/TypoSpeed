...
const SignInRight = () => {
    return (
        <div className="flex flex-col items-center justify-center p-3 md:p-10 min-w-100 h-[600px] bg-secondary gap-3 md:gap-5 text-lightcolor rounded-2xl md:rounded-tl-none md:rounded-bl-none md:rounded-tr-2xl md:rounded-br-2xl overflow-hidden">
            ...
            <div className="flex gap-2 text-sm md:text-base">
                ...
                <a className="text-blue-500" href="http://localhost:5173/signup">Sign Up</a>
            </div>
